...
<div class="container">
 ...
 <div class="col-md-3 mb-3">
  ...
  <div class="form-row">
    ...
    <input type="text" class="form-control" id="cep" placeholder="Digite Cep" name="cep" onblur="pesquisacep(this.value) value="<%out.print(request.getAttribute("idaluno"));%>>
  </div>
  
 <div class="col-md-8 mb-3">
    <label for="rua">Rua</label>
    <input type="text" class="form-control" id="rua" placeholder="" name="rua" value="<%out.print(request.getAttribute("rua"));%>">
  </div>
